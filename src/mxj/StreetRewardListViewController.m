//
//  StreetRewardListViewController.m
//  mxj
//
...
@interface StreetRewardListViewController () <UITableViewDataSource, UITableViewDelegate>
{
...
@implementation StreetRewardListViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    RewardInfo *info = _listArray[indexPath.row];
...
{
    RewardInfo *info = _listArray[button.tag];
